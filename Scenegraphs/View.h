...
public:
	...
	void rotateCam(bool turnRight);
	void moveCam(bool forward);

	//Set maze wall data for player-wall detection
	void setMazeWallData(vector<vector<int>> mazeWallData);
...
private:
	...
	GLint projectionLocation, modelviewLocation, objectColorLocation, choiceLocation;
